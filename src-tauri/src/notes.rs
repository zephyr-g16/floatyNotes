...
// ----- This is from the original CLI tool -----
// ----- I have brought it over so i dont have to rewrite it if i decide to use it -----
// ----- DELETE IF UNUSED BY RELEASE TIME!!! -----
// struct App {
//     notes: Vec<Note>,
//     loaded: bool,
// }
...
// ----- This section is from the original CLI tool -----
// ----- I have it here in case i want to use these commands later -----
// ----- DELETE IF UNUSED BY RELEASE -----
//
